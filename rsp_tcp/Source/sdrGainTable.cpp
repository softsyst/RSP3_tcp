...
void gainConfiguration::createGainConfigTables()
{
		...
		// RSP1
		gainTables[0].setSize(MAX_LNA_STATES, internalBands, grInvalid);

		// RSP1A
		gainTables[1].setSize(MAX_LNA_STATES, internalBands, grInvalid);

		// RSP2
		gainTables[2].setSize(MAX_LNA_STATES, internalBands, grInvalid);

		//RSPduo
		gainTables[3].setSize(MAX_LNA_STATES, internalBands, grInvalid);

		//RSPdx
		gainTables[4].setSize(MAX_LNA_STATES, internalBands, grInvalid);
