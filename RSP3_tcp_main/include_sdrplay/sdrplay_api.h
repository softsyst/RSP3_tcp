...
#if (defined(_M_X64) || defined(_M_IX86) || defined(_M_ARM64)) && !defined(__GNUC__) //ext. cs
#include "windows.h"
...
#if (!defined(STATIC_LIB) && (defined(_M_X64) || defined(_M_IX86) || defined(_M_ARM64))) && !defined(__GNUC__)  //ext. cs
